...
public class EditProfilePage extends AppCompatActivity {
        ...
        if (!isConnected(this)) {
            ...
            back.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent showDetail = new Intent(EditProfilePage.this, HomePage.class);
   ...
   //end
    ...
    private void showInternetDialog() {
        ...
        view.findViewById(R.id.try_again).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!isConnected(EditProfilePage.this)) {
                    showInternetDialog();
                } else {
    ...
    private boolean isConnected(EditProfilePage dashboardActivity) {
