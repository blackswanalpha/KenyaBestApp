...
import com.example.kenyabestapp.databinding.ActivityOtpVerifyBinding;
...
public class OtpVerifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.tvMobile.setText(String.format(
                "+2547-%s", getIntent().getStringExtra("phone")
        ));
...
//                                });
                        firebaseAuth.getCurrentUser().linkWithCredential(credential).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                         ...
                         Toast.makeText( OtpVerifyActivity.this, "Acccount Created and Linked.", Toast.LENGTH_SHORT).show();
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText( OtpVerifyActivity.this, "Error: "+ e.getMessage(), Toast.LENGTH_SHORT).show();
