...
import com.example.kenyabestapp.databinding.ActivityOtpSendBinding;
    ...
    private void otpSend() {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                Toast.makeText(OtpSendActivity.this, e.getLocalizedMessage(), Toast.LENGTH_LONG).show();
            }
        ...
        PhoneAuthOptions options =
                PhoneAuthOptions.newBuilder(mAuth)
                        .setPhoneNumber("+2547" + binding.etPhone.getText().toString().trim())
