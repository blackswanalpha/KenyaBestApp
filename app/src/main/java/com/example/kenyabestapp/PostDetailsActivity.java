        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    hisdp = String.valueOf(dataSnapshot1.child("udp").getValue());
                    // hisuid = dataSnapshot1.child("uid").getValue().toString();
                    String uemail = String.valueOf(dataSnapshot1.child("uemail").getValue());
                    hisname = String.valueOf(dataSnapshot1.child("uname").getValue());
                    ptime = String.valueOf(dataSnapshot1.child("ptime").getValue());
                    plike = String.valueOf(dataSnapshot1.child("plike").getValue());
                    String commentcount = String.valueOf(dataSnapshot1.child("pcomments").getValue());
